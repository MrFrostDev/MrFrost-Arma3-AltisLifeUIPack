...
#define FROST_GUI_GRID_CENTER_WAbs     ((safezoneW / safezoneH) min 1.2)
#define FROST_GUI_GRID_CENTER_HAbs     (FROST_GUI_GRID_CENTER_WAbs / 1.2)
#define FROST_GUI_GRID_CENTER_W        (FROST_GUI_GRID_CENTER_WAbs / 40)
#define FROST_GUI_GRID_CENTER_H        (FROST_GUI_GRID_CENTER_HAbs / 25)
#define FROST_GUI_GRID_CENTER_X        (safezoneX + (safezoneW - FROST_GUI_GRID_CENTER_WAbs)/2)
#define FROST_GUI_GRID_CENTER_Y        (safezoneY + (safezoneH - FROST_GUI_GRID_CENTER_HAbs)/2)

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////// MrFrost Base Classes ////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

class MrFrost_RscText
{
	access = 0;
	type = 0;
	idc = -1;
...
class MrFrost_RscStructuredText {
    type = 13;
    style = 0;
    x = 0;
    y = 0;
...
class MrFrost_RscTree {
	...
	x = 12 * FROST_GUI_GRID_CENTER_W + FROST_GUI_GRID_CENTER_X; // Horizontal coordinates
	y = 3 * FROST_GUI_GRID_CENTER_H + FROST_GUI_GRID_CENTER_Y; // Vertical coordinates
	w = 10 * FROST_GUI_GRID_CENTER_W; // Width
	h = 3 * FROST_GUI_GRID_CENTER_H; // Height

	colorBorder[] = {0,0,0,0}; // Frame color
	colorLines[] = {1,1,1,1};

	colorBackground[] = {0.2,0.2,0.2,1}; // Fill color
	colorSelect[] = {0.8549,0.29412,0,1}; // Selected item fill color (when multiselectEnabled is 0)
	colorMarked[] = {0.8549,0.29412,0,0.5}; // Marked item fill color (when multiselectEnabled is 1)
	colorMarkedSelected[] = {0.8549,0.29412,0,1}; // Selected item fill color (when multiselectEnabled is 1)
...
class MrFrost_RscControlsGroup {
    type = 15;
    idc = -1;
    x = 0;
    y = 0;
    ...
    class VScrollBar : MrFrost_RscScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : MrFrost_RscScrollBar
    {
        height = 0.028;
    };
...
class MrFrost_RscControlsGroupNoScrollbars : MrFrost_RscControlsGroup {
...
class MrFrost_Checkbox
{
    ...
    x = 0;
    y = 0;
    w = 1 * FROST_GUI_GRID_CENTER_W; // Width
    h = 1 * FROST_GUI_GRID_CENTER_H; // Height
...
class MrFrost_RscListNBox
{
    ...
    autoScrollDelay = 5;
    autoScrollRewind = 0;
    class ListScrollBar: MrFrost_RscScrollBar{};
    class ScrollBar: MrFrost_RscScrollBar{};
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

class MrFrost_RscLine: MrFrost_RscText {
    idc = -1;
    style = 176;
    x = 0.17;
    y = 0.48;
...
class MrFrost_RscTitle: MrFrost_RscText {
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
    colorText[] = {0.95, 0.95, 0.95, 1};
};
...
class MrFrost_RscTextMulti: MrFrost_RscText
{
    linespacing = 1;
    style = 0 + 16 + 0x200;
};
...
class MrFrost_RscPictureKeepAspect : MrFrost_RscPicture
{
    style = 2048 + 16 + 32;
};
...
class MrFrost_RscButtonTextOnly : MrFrost_RscButton {
...
class MrFrost_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    shadow = 1;
...
class MrFrost_RscButtonMenu : MrFrost_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class MrFrost_RscShortcutButtonMain : MrFrost_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    w = 0.313726;
...
class MrFrost_RscBackground: MrFrost_RscText {
    type = 0;
    IDC = -1;
    style = 512;
    shadow = 0;
...
class MrFrost_RscCombo {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
     ...
     class ComboScrollBar : MrFrost_RscScrollBar {};
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

class MrFrost_RscToolbox {
    colorText[] = {0.95, 0.95, 0.95, 1};
    color[] = {0.95, 0.95, 0.95, 1};
...
class MrFrost_MammutRP_RscShortcutButton
{
	deletable = 0;
	fade = 0;
...
class MrFrost_MammutRP_RscButtonMenu: MrFrost_MammutRP_RscShortcutButton
{
	idc = -1;
	type = 16;
	style = "0x00";
	...
	animTextureOver = "#(argb,8,8,3)color(0.69,0,0,1)";
	animTextureFocused = "#(argb,8,8,3)color(0,0,0,0)";
	animTexturePressed = "#(argb,8,8,3)color(0.69,0,0,1)";
